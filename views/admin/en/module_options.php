...
$aLang = [
    ...
    'SHOP_MODULE_sandbox-UnzerPublicKeyB2CEUR' => 'Sandbox Public-Key for B2C EUR',
    'SHOP_MODULE_sandbox-UnzerPrivateKeyB2CEUR' => 'Sandbox Private-Key for B2C EUR',
    'SHOP_MODULE_production-UnzerPublicKeyB2CEUR' => 'Production Public-Key for B2C EUR',
    'SHOP_MODULE_production-UnzerPrivateKeyB2CEUR' => 'Production Private-Key for B2C EUR',
    'SHOP_MODULE_sandbox-UnzerPublicKeyB2BEUR' => 'Sandbox Public-Key for B2B EUR',
    'SHOP_MODULE_sandbox-UnzerPrivateKeyB2BEUR' => 'Sandbox Private-Key for B2B EUR',
    'SHOP_MODULE_production-UnzerPublicKeyB2BEUR' => 'Production Public-Key for B2B EUR',
    'SHOP_MODULE_production-UnzerPrivateKeyB2BEUR' => 'Production Private-Key for B2B EUR',
    'SHOP_MODULE_sandbox-UnzerPublicKeyB2CCHF' => 'Sandbox Public-Key for B2C CHF',
    'SHOP_MODULE_sandbox-UnzerPrivateKeyB2CCHF' => 'Sandbox Private-Key for B2C CHF',
    'SHOP_MODULE_production-UnzerPublicKeyB2CCHF' => 'Production Public-Key for B2C CHF',
    'SHOP_MODULE_production-UnzerPrivateKeyB2CCHF' => 'Production Private-Key for B2C CHF',
    'SHOP_MODULE_sandbox-UnzerPublicKeyB2BCHF' => 'Sandbox Public-Key for B2B CHF',
    'SHOP_MODULE_sandbox-UnzerPrivateKeyB2BCHF' => 'Sandbox Private-Key for B2B CHF',
    'SHOP_MODULE_production-UnzerPublicKeyB2BCHF' => 'Production Public-Key for B2B CHF',
    'SHOP_MODULE_production-UnzerPrivateKeyB2BCHF' => 'Production Private-Key for B2B CHF',
];