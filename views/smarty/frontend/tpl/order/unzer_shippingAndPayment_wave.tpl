            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    [{if $sPaymentID == "oscunzer_card"}]
                        [{include file="@unzer/unzer_card.tpl"}]
                    [{elseif $sPaymentID == "oscunzer_eps"}]
                        [{include file="@unzer/unzer_eps_charge.tpl"}]
                    [{elseif $sPaymentID == "oscunzer_ideal"}]
                        [{include file="@unzer/unzer_ideal.tpl"}]
                    [{elseif $sPaymentID == "oscunzer_installment"}]
                        [{include file="@unzer/unzer_installment.tpl"}]
                    [{elseif $sPaymentID == "oscunzer_invoice"}]
                        [{include file="@unzer/unzer_invoice.tpl"}]
                    [{elseif $sPaymentID == "oscunzer_paypal"}]
                        [{include file="@unzer/unzer_paypal.tpl"}]
                    [{elseif $sPaymentID == "oscunzer_applepay"}]
                        [{include file="@unzer/unzer_applepay.tpl"}]
                    [{elseif $sPaymentID == "oscunzer_sepa"}]
                        [{include file="@unzer/unzer_sepa.tpl"}]
                    [{elseif $sPaymentID == "oscunzer_sepa-secured"}]
                        [{include file="@unzer/unzer_sepa_secured.tpl"}]
                    [{/if}]
                </div>
            </div>
        </div>
