...
$aLang = [
    ...
    'OSCUNZER_ERROR_TRANSMITTING_APPLEPAY_MERCHANT_ID_TOO_SHORT' => 'ApplePay: Händler ID ist zu kurz',
    'OSCUNZER_ERROR_TRANSMITTING_APPLEPAY_MERCHANT_ID_EMPTY' => 'ApplePay: Händler ID ist leer',
