...
class Email extends Email_parent
{
     ...
     * @var string
     */
    protected $unzerRefundTplHtml = "@osc-unzer/frontend/tpl/email/html/refund";
     ...
     * @var string
     */
    protected $unzerRefundTplPlain = "@osc-unzer/frontend/tpl/email/plain/refund";
     ...
     * @var string
     */
    protected $unzerCancelTplHtml = "@osc-unzer/frontend/tpl/email/html/cancel";
     ...
     * @var string
     */
    protected $unzerCancelTplPlain = "@osc-unzer/frontend/tpl/email/plain/cancel";
    /**
     * @param Order $order
    ...
    protected function sendUnzerOrderMail(
        ...
        $wasAdmin = $this->switchUnzerAdminMode(false);
        ...
        try {
            ...
            $this->switchUnzerAdminMode($wasAdmin);
            if ($mailLanguage !== null) {
     ...
     */
    protected function switchUnzerAdminMode(bool $isAdmin): bool
    {
